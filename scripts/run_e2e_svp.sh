...
echo "[Step 2/4] SVP-GAM prune + surgery ..."
$PY prune_svp.py --data-path $DATA --checkpoint $OUT/step1_dense/model_best.pth \
    --target-rate $TARGET_RATE --finetune-epochs $FINETUNE_EPOCHS --scope $SCOPE \
