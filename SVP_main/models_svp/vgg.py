...
def vgg_16_bn(compress_rate=[0.0] * 13, num_classes=10):
    return VGG(
        compress_rate=compress_rate, num_classes=num_classes, cfg=defaultcfg["vgg16"]
    )


def vgg_19_bn(compress_rate=[0.0] * 16, num_classes=100):
    return VGG(
        compress_rate=compress_rate, num_classes=num_classes, cfg=defaultcfg["vgg19"]
    )
