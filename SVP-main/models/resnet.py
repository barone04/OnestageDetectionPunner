...
def adapt_channel(compress_rates, layers):
    ...
    Args:
        compress_rates (list): Compression rates for different stages.
        layers (list): Number of layers in each stage.

    Returns:
        tuple: (overall_channel, mid_channel)
    """
    num_stages = len(layers)  # Determine number of stages
